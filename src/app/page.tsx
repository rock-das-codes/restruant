      ...
      <section className="py-16 bg-[#8B0000]">
        <div className="container mx-auto px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button className="bg-yellow-500 hover:bg-yellow-600 text-[#8B0000] font-bold px-8 py-3 rounded">Order Online</Button>
            <Button variant="outline" className="border-2 border-white hover:bg-white text-[#8B0000]  font-bold px-8 py-3 rounded">
              Book A Table
            </Button>
          </div>
        </div>
